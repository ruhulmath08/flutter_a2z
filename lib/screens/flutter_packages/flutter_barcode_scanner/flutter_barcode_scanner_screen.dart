...
class FlutterBarcodeScannerScreen extends StatefulWidget {
  ...
  const FlutterBarcodeScannerScreen({Key? key, required this.title, required this.model}) : super(key: key);

  @override
  _FlutterBarcodeScannerScreenState createState() => _FlutterBarcodeScannerScreenState();
}
...
class _FlutterBarcodeScannerScreenState extends State<FlutterBarcodeScannerScreen> {
  ...
  Future<void> startBarcodeScanStream() async {
    FlutterBarcodeScanner.getBarcodeStreamReceiver('#ff6666', 'Cancel', true, ScanMode.BARCODE)!.listen((barcode) => log(barcode.toString()));
  }
