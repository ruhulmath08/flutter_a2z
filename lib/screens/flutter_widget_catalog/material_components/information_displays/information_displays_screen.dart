...
class InformationDisplaysScreens extends StatelessWidget {
  final String title;
  const InformationDisplaysScreens({Key? key, required this.title}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final List<InformationDisplaysModel> models = InformationDisplaysModel.fetchAll();
    return Scaffold(
      appBar: AppBar(
        title: Text(title),
      ),
