...
class HomeCardItem {
  ...
  static List<HomeCardItem> fetchAll() {
    return [
      ...
      HomeCardItem(9, 'Form', Icons.format_align_justify),
      HomeCardItem(10, 'Google Sheet', Icons.explicit_rounded),
      HomeCardItem(11, 'GridView', Icons.grid_on_outlined),
      HomeCardItem(12, 'ListView', Icons.list),
      HomeCardItem(13, 'TabView', Icons.table_view_rounded),
      HomeCardItem(14, 'BottomNavigation', Icons.backup_table_sharp),
      HomeCardItem(15, FLUTTER_TABLE_SCREEN_TITLE, Icons.table_chart),
      HomeCardItem(16, 'Maps', Icons.location_pin),
      HomeCardItem(17, 'SQLite', Icons.cloud),
      HomeCardItem(18, 'Drawer', Icons.navigation),
      HomeCardItem(19, 'Flutter CRUD', Icons.add_to_photos_rounded),
      HomeCardItem(20, 'Flutter Chip', Icons.check_circle),
      HomeCardItem(21, 'Biometric Auth', Icons.fingerprint_outlined),
      HomeCardItem(22, FLUTTER_PACKAGES_SCREEN_TITLE, Icons.waves),
